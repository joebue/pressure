                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.trips.update", [$trip->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('trip_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="trip_name" id="trip_name" value="{{ old('trip_name', $trip->trip_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $trip->description) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('travel_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="travel_time" id="travel_time" value="{{ old('travel_time', $trip->travel_time) }}" required>
